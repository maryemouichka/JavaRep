...
public class Zoo {
    ...
    public boolean addAquaticAnimal(Aquatic aquatic) {
        if (nbrAquaticAnimals >= aquaticAnimals.length) {
            System.out.println("Maximum aquatic animals reached!");
            return false;
        }
    ...
    public float MaxpenguinSwimmingDepth() {
        ...
        for (int i = 0; i < nbrAquaticAnimals; i++) {
            ...
            if (aquaticAnimals[i] instanceof Penguin) {
                ...
                Penguin p = (Penguin) aquaticAnimals[i]; // cast
    ...
    public void displayNumberOfAquaticsByType() {
        ...
        System.out.println("Number of other Aquatics: " + otherAquaticCount);
    }
}
